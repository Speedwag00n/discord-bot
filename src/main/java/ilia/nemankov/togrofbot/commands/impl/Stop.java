...
public class Stop extends AbstractCommand {
    ...
    private static final String[] variants = new String[] {"stop"};
    ...
    public Stop() {
        ...
        commandItems.add(new DefaultStop());
        setCommandItems(commandItems);
    }

    private class DefaultStop extends CommandItem {
        ...
        public CommandVariantDescription getDescription() {
            ...
            CommandVariantDescription description = new CommandVariantDescription(
                    resources.getString("description.command.stop.default.args"),
                    resources.getString("description.command.stop.default.desc")
            );
            return description;
        }
        ...
        public String execute(GuildMessageReceivedEvent event, List<Argument> arguments) {
            ...
            if (audioManager.getConnectedChannel() == null) {
                return resources.getString("message.command.stop.not_in_channel");
            } else {
                if (audioManager.isAttemptingToConnect()) {
                    ...
                    if (musicManager.getTrackScheduler().getPlayingNow() != null) {
                        ...
                        return resources.getString("message.command.stop.nothing");
                    }
                }
            }
        }
